...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemEmbed.width'
        db.delete_column(u'cms_itemembed', 'width')

        # Deleting field 'ItemEmbed.height'
        db.delete_column(u'cms_itemembed', 'height')


    def backwards(self, orm):
        # Adding field 'ItemEmbed.width'
        db.add_column(u'cms_itemembed', 'width',
                      self.gf('django.db.models.fields.IntegerField')(default=300),
                      keep_default=False)

        # Adding field 'ItemEmbed.height'
        db.add_column(u'cms_itemembed', 'height',
    ...
    models = {
        ...
        u'cms.galleryimage': {
            ...
            'min_width': ('django.db.models.fields.IntegerField', [], {'default': '250'}),
