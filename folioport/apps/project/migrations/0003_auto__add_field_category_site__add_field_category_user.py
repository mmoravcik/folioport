...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'project_category', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['account.FolioportUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.site'
        db.delete_column(u'project_category', 'site_id')

        # Deleting field 'Category.user'
        db.delete_column(u'project_category', 'user_id')
