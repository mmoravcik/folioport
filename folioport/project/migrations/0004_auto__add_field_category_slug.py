...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('project_category', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=128, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.slug'
        db.delete_column('project_category', 'slug')
