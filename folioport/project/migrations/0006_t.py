...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('project_project', 'rating_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Project.rating_score'
        db.add_column('project_project', 'rating_score', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.rating_votes'
        db.delete_column('project_project', 'rating_votes')

        # Deleting field 'Project.rating_score'
        db.delete_column('project_project', 'rating_score')
